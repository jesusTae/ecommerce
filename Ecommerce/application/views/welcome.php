...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo base_url('asset/img/slider/Slide2.jpg')?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo base_url('asset/img/slider/Slide3.jpg')?>" alt="Third slide">
    </div>
  </div>
...
<section class="col-md-12" style="padding: 2%">
	...
	<div class="row">
		<div class="col-md-4">
      		<img src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" style="height: 23.5em;">
		</div>
		<div class="col-md-4">
			<img src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" style="height: 11.2rem; margin-bottom: 4%; width: 26rem;">
			<img src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" style="height: 11.2rem; margin-bottom: 4%; width: 26rem;">
		</div>
		<div class="col-md-4">
			<img src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" style="height: 23.5em;">
			...
			<div class="card-body">
				<div class="col-md-4"> 
                    <div class="intro-item">
                    	<center>
	                        <figure>
	                            <img src="<?php echo base_url('asset/img/slider/Slide1.jpg')?>" alt="#" width="200" height="200" class="border_radius">
	                        </figure>
